...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { dataCompra: @produto.dataCompra, nome: @produto.nome, quantidade: @produto.quantidade, valor: @produto.valor } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { dataCompra: @produto.dataCompra, nome: @produto.nome, quantidade: @produto.quantidade, valor: @produto.valor } }
